$(document).ready(function(){
    ...
    $('.passos').click( function(){
        if (ii + jj + kk == 3) {
            ...
            $('.passos').not(this).css({width: "0px", height: "0px", padding: "0px", transition: "0.2s"});
            $(this).css({width: "100%", height: "100%", margin: "0px", cursor: "auto", transition: "0.3s"});
            $('.passos-titulo').slideUp(300);
            $('.passos-texto p').slideUp(300);
            $('#calcular').slideUp(300);
